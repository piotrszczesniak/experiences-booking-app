...
const typeMap: any = {
  ...
  Links: o(
    [
      ...
      },
      {
        ...
        typ: u(undefined, a(r('PredecessorVersion'))),
      },
      {
        json: 'wp:featuredmedia',
        js: 'wp:featuredmedia',
        typ: a(r('AuthorElement')),
      },
  ...
  YoastHeadJSON: o(
    [
      ...
      {
        json: 'article_published_time',
        js: 'article_published_time',
        typ: Date,
      },
      {
        json: 'article_modified_time',
        js: 'article_modified_time',
  ...
  Robots: o(
    [
      ...
      {
        json: 'max-image-preview',
        js: 'max-image-preview',
        typ: r('MaxImagePreview'),
      },
      {
        json: 'max-video-preview',
        js: 'max-video-preview',
        typ: r('MaxVideoPreview'),
      },
    ],
    false
  ),
  ...
  Graph: o(
    [
      ...
      { json: 'name', js: 'name', typ: u(undefined, '') },
      {
        json: 'isPartOf',
        js: 'isPartOf',
        typ: u(undefined, r('BreadcrumbClass')),
      },
      ...
      },
      {
        json: 'inLanguage',
        js: 'inLanguage',
        typ: u(undefined, r('InLanguage')),
      },
      {
        json: 'potentialAction',
        js: 'potentialAction',
        typ: u(undefined, a(r('PotentialAction'))),
      },
      {
  ...
  BreadcrumbClass: o([{ json: '@id', js: '@id', typ: '' }], false),
  Image: o(
    [
  ...
  PostsDType: ['post'],
  AuthorEnum: ['Piotr Sz.'],
  OgImageType: ['image/jpeg', 'image/png', 'image/webp'],
  OgLocale: ['en_GB'],
  OgSiteName: ['Bumper Ball | Experiences'],
  OgType: ['article'],
  Follow: ['follow'],
  Index: ['index'],
  ...
  GraphType: ['BreadcrumbList', 'Person', 'WebPage', 'WebSite'],
  ImageType: ['ImageObject'],
  InLanguage: ['en-GB'],
  ItemListElementType: ['ListItem'],
  PotentialActionType: ['ReadAction', 'SearchAction'],
  QueryInput: ['required name=search_term_string'],
  TargetType: ['EntryPoint'],
  URLTemplate: ['https://bumperball.pl/?s={search_term_string}'],
  TwitterCard: ['summary_large_image'],
  TwitterCreator: ['@pio_szczesniak'],
  TwitterSite: ['@Bumper_Ball'],
};
